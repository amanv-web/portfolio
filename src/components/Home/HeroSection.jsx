      ...
      <div className="flex items-center justify-around gap-40  h-screen pb-10">
        ...
        >
          ...
          <div className="flex space-x-4 pt-5 ">
            <button className=" hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full h-full  bg-gray-400  bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100 ">
              Hire Me
            </button>
        ...
        <div>
          <motion.img
            ...
            alt="Profile"
            className="w-90 h-90 rounded-full shadow-[8px_8px_16px_#1a1a1a,-8px_-8px_16px_#2a2a2a] hover:scale-105 transition-all"
          />
        </div>
      </div>
    </>
