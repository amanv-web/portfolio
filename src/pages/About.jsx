        ...
        <div className="  pt-5 w-4/6  h-screen " >
          ...
          {words.map((word, index) => (
                    <motion.span
                        ...
                        transition={{ delay: index * 0.015, duration: 1, type: "spring", bounce: 0 }}
                        viewport={{ top: 40, bottom: 20 }}
                    >
                        {word}
                    </motion.span>
                ))}
